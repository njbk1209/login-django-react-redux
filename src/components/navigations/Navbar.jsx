...
import { guestLinks, AuthLinks } from './LinksNav'
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-600'
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
                            ...
                            >
                              <div className="flex md:h-full lg:flex-col">
                                <div className="flex-shrink-0">
                                  <span className="inline-flex items-center justify-center h-10 w-10 rounded-md bg-yellow-700 text-white sm:h-12 sm:w-12">
                                ...
                                <div className="ml-4 md:flex-1 md:flex md:flex-col md:justify-between lg:ml-0 lg:mt-4">
                                  ...
                                  <p className="mt-2 text-sm font-medium text-yellow-600 lg:mt-4">
                ...
                <nav>
                  <div className="grid gap-7 sm:grid-cols-2 sm:gap-y-8 sm:gap-x-4">
                    {solutions.map((item) => (
                      ...
                      >
                        <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-yellow-700 text-white sm:h-12 sm:w-12">
                          <item.icon className="h-6 w-6" aria-hidden="true" />
                        </div>
              ...
              <div className="mt-6">
                {
                  isAuthenticated ?
                    <button
                      ...
                      className="inline-flex items-center justify-center px-4 py-2 rounded border-transparent shadow-sm text-base font-medium bg-yellow-700 text-white transition ease-in-out duration-300 hover:scale-105"
                    >
                      Logout
                    </button>
                    :
                    ...
                    >
                      ...
                      <p className="mt-6 text-center text-base font-medium text-gray-500">
                        ...
                        <Link to="/register" className="text-yellow-700 hover:text-yellow-800">
                          Sign up
                        </Link>
                      </p></>
                    )
